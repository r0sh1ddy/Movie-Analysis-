...
4. *(Bonus)* Are there lesser-known but high-return film types being overlooked?
...
**Python Example**  
![ROI by Genre Python](visuals/roi_by_genre_py.png)

**Tableau Dashboard**  
![ROI by Genre Tableau](visuals/roi_by_genre_tableau.png)
...
**Python Example**  
![ROI by Month Python](visuals/roi_by_month_py.png)

**Tableau Dashboard**  
![ROI by Month Tableau](visuals/roi_by_month_tableau.png)
...
**Python Example**  
![Popularity vs Rating Python](visuals/popularity_vs_rating_py.png)

**Tableau Dashboard**  
![Popularity vs Rating Tableau](visuals/popularity_vs_rating_tableau.png)
